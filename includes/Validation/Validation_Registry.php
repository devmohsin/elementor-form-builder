...
class CLEFA_Validation_Registry {
	...
	private static function register_core_rules(): void {
		...
		self::register( array(
			...
			'description'       => __( 'Date must be after the specified date (YYYY-MM-DD).', 'codelinden-elementor-form-addon' ),
			'applies_to'        => $date_types,
			'has_value'         => true,
			'value_type'        => 'date',
		...
		self::register( array(
			...
			'description'       => __( 'Date must be before the specified date (YYYY-MM-DD).', 'codelinden-elementor-form-addon' ),
			'applies_to'        => $date_types,
			'has_value'         => true,
			'value_type'        => 'date',
