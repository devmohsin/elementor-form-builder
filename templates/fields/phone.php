<?php
/**
 * Field template: phone (uses text template with tel type)
 *
...
<input
	...
	class="clefa-input clefa-input-phone<?php echo $has_error ? ' clefa-input-error' : ''; ?>"
	placeholder="<?php echo esc_attr( $placeholder ?: __( '+1 234 567 8900', 'codelinden-elementor-form-addon' ) ); ?>"
	autocomplete="tel"
